...
`scene_catalog/` 是第一期场景词汇课程的机器可读任务目录。课程共包含 **64 张竖版场景图、每图 10 个目标词、640 个学习位**；按英文表达去重后为 633 个词条。
...
建议先制作 A 批，用它验证生图、目标定位、标注和视频节奏，再扩展到 B、C 批。
...
- 校验 64 个场景、每场景 10 个词、共 640 个学习位和 633 个独立英文词条；
