...
`scene_catalog/` 是场景词汇课程的机器可读任务目录。课程共包含 **136 张竖版场景图、每图 10 个目标词、1360 个学习位**；按英文表达去重后为 1354 个词条。
...
| E | 驾驶与车辆、宠物与动物照护、自然天气与乡野、安全与应急、节庆与人生事件 | 30 | 300 |
| F | 科学与探索、海洋港口与水上活动、工业能源与环保、家装维修与 DIY | 24 | 240 |
...
- `generation.visual_plan`：可选的场景专属镜头、构图、动作与光线设计；
...
- 校验 136 个场景、每场景 10 个词、共 1360 个学习位和 1354 个独立英文词条；
- 根据 `scene`、`targets` 和可选的 `generation.visual_plan` 自动重建 `generation.prompt`；
